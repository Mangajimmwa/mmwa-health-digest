...
function ArticlePage() {
  ...
  if (error || !article || isScannerPath) {
    return (
      <SiteLayout>
        <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4 max-w-md mx-auto text-center">
    ...
    <SiteLayout>
      ...
      <article className="mx-auto max-w-3xl px-4 lg:px-6 py-14">
        ...
        <div className="mt-14 border-t border-border pt-8">
          ...
          <div className="flex flex-wrap gap-3 items-center">
            ...
            <a 
              ...
              style={{ color: "#25D366", boxShadow: "0 0 12px rgba(37, 211, 102, 0.35)" }}
        ...
        <div className="mt-12 border-t border-border pt-10">
          <div className="mb-6">
            <h3 className="font-display font-bold text-xl text-foreground">Comments</h3>
            <p className="text-xs text-text-mute font-serif mt-1">Share your thoughts</p>
          </div>
        ...
        {showAuthModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
            <div className="bg-surface-1 border border-border rounded-2xl p-6 sm:p-8 max-w-md w-full relative shadow-2xl space-y-5">
              <button 
