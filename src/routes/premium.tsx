        ...
        >
          ...
          <div className="mx-auto max-w-4xl px-4 lg:px-6 relative z-10">
            ...
            <p className="mt-5 text-sm sm:text-base text-text-body font-serif max-w-3xl mx-auto leading-relaxed opacity-90">
              No sponsored fluff, no pop-up ads, and zero corporate influence. Step inside the global desk for direct access to unvarnished medical investigations, real-time outbreak tracking, peer-reviewed scientific breakdowns, and exclusive briefing intelligence.
            </p>
